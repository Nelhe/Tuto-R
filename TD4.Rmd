...
Le jeu de données weatherMelbourne (disponible dans le dossier data) contient des relevés météo quotidiens pour la ville de Melbourne. Pour chaque jour, les variables mesurées sont les suivantes :
